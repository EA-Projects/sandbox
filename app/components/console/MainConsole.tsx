  ...
  return (
    <div className="col-span-6 flex flex-col gap-y-[11px] w-[70%] gap-x-[16px] h-full">
      <div className="flex flex-row w-full gap-x-[16px] items-center">
       <div className="overall-icons flex flex-row items-center relative">
          <motion.div
            className="source-status sources-processing-status uppercase"
            initial={{ opacity: 1 }}
            animate={{ opacity: 0 }}
            transition={{ 
              duration: 0.2,
          ...
          <motion.div
            className="source-status sources-done-status uppercase"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ 
              duration: 0.2,
      ...
      {/* BarProcessing component is used to show the progress of the phase */}
